...
| **Storage Account + Blob Container** | `compliancekb` / `kb-documents` | Standard LRS |

> [!TIP]
> If you are the workshop facilitator, these resources are provisioned by following [Module II: Provisioning Azure Resources](./02_Azure_Resources.md) in advance. Participants can then verify access and proceed directly to the agent design steps.
